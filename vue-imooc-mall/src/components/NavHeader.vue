/**
 * @description: 头部导航
 * @author: zth[zhutianhe136@163.com]
 * @date: 2019-07-27
*/
<template>
  <header class="header">
    ...
    <div class="navbar">
      <div class="navbar-left-container">
        <a href="/">
          <img src="/static/logo.png" alt class="navbar-brand-logo" />
        </a>
      </div>
      <div class="navbar-right_container" style="display: flex">
        <div class="navbar-menu-container">
          ...
          <div class="navbar-cart-container">
            <span class="navba-cart-count" v-text="cartCount" v-if="cartCount"></span>
            ...
            <ul>
              <li class="regi-form-input">
                ...
                <input
                  ...
                  name="loginName"
                  v-model="userName"
                  class="regi-login-input regi-login-input-left"
              ...
              <li class="regi-form-input noMargin">
                ...
                <input
                  ...
                  name="password"
                  v-model="userPwd"
                  class="regi-login-input regi-login-input-left login-input-noinput-text"
