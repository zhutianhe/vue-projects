...
```javascript
import Vue from 'vue';
import ElementUI from 'cst-ui';
import 'cst-ui/lib/theme-chalk/index.css';
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'cst-ui';
import App from './App.vue';
